    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else if (args[0]== Constants.ShowRandom)
            {
                ...
                // TODO: The sequence of random numbers generated by a single Random instance
            ...
            else if (args[0].Contains(Constants.FindEntry))
            {
                ...
                {
                    if (students[idx].Trim() == searchTerm)
                    {
                        indexLocation = idx;
                        break;
                    }
            ...
            // TODO: Contains is too arbitrary. The argument should equal this constant.
